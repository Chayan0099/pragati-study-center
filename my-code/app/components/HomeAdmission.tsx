...
export default function HomeAdmission() {
    return <div className="flex bg-gradient-to-br from-green-500 to-green-700 mt-5 mx-4 rounded-lg py-2 px-3 gap-3 items-center shadow-lg shadow-green-700/50">
